...
const expenseRecipientRoutes = require('../modules/expenses/expense_recipient.routes');
...
const userCashflowRoutes = require('../modules/reports/user-cashflow.routes');
...
router.use('/expense-recipients', expenseRecipientRoutes);
...
router.use('/user-cashflow', userCashflowRoutes);
