    ...
    try {
      ...
      return {
        summary: {
          ...
          totalDebtorBorrowed: parseFloat(results.totalDebtorBorrowed.total),
          totalDebtorReturned: parseFloat(results.totalDebtorReturned.total),
          totalSalaryPayments: parseFloat(results.totalSalaryPayments.total),
          profit: profit,
